...
def main():
    ...
    with tab_summary:
        ...
        if status_mode == "I am still working":
            ...
            if annual_income == 0:
                st.info("💡 **Tip:** Enter your information in the **Financial Data** tab to find out how much you should be saving.")
            ...
            if investments_total == 0 and target_spend == 0:
                st.info("💡 **Tip:** Enter your information in the **Financial Data** tab to find out how much more money you can spend.")
            else:
...
# NO_OP - Searching first
        ...
        if (principal or 0.0) >= 0: # Allow 0 expenses or income
            ...
            st.info("💡 **Tip:** Check below to see how much more money you can withdraw.")
            with st.container(border=True):
    ...
    # --- What If Section (Merged) ---
        ...
        st.info("💡 **Tip:** Enter big ticket items below and see how these choices affect your net worth.")
